...
returnURL        = "http://localhost:95/MOBILE_TX_ASP64/payResult_utf.asp"
charSet          = "utf-8"
...
<body>
<form name="payForm" target="_self" method="post" action="https://web.nicepay.co.kr/smart/paySmart.jsp" accept-charset="euc-kr">
